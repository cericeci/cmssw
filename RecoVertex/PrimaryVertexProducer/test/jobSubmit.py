...
proxy_path = os.getcwd() + "/x590_proxy" # This is where your proxy will be held for access by batch system
...
param = str(sys.argv[6]) # Parameter in the algorithm that is set, i.e. "Old" or "New" 
