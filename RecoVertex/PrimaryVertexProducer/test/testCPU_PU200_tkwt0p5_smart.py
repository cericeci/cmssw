...
process.offlinePrimaryVertices.TkClusParameters.TkDAClusParameters.smartBlocks = cms.bool(True)
...
process.offlinePrimaryVertices.TkClusParameters.TkDAClusParameters.mintrkweight = cms.double(0.5)
