...
// 
/**\class CSCTimingExtractor_Mini CSCTimingExtractor_Mini.cc RecoMuon/MuonIdentification/src/CSCTimingExtractor_Mini.cc
 *
...
#include "UserCode/MuonTiming/interface/CSCTimingExtractor_Mini.h"
...
CSCTimingExtractor_Mini::~CSCTimingExtractor_Mini()
{
}
...
void CSCTimingExtractor_Mini::fillTiming(TimeMeasurementSequence &tmSequence,
...
void
CSCTimingExtractor_Mini::fillTiming(TimeMeasurementSequence &tmSequence, reco::TrackRef muonTrack, 
                               const edm::Event& iEvent, const edm::EventSetup& iSetup)
{
...
//DEFINE_FWK_MODULE(CSCTimingExtractor_Mini);
