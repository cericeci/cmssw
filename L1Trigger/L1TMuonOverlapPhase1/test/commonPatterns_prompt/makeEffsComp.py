...
datasets = {
   ...
   #'Prompt_LowPt_NoPU_AP'   : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/Disp_2to10_0to3000_NoPU/200724_204327/0000/',},
   #'Prompt_LowPt_PU200_AP'  : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/Disp_2to10_0to3000_PU200/200724_205409/0000/',},
    #'Prompt_MidPt_NoPU_SP'   : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/24Jul_bothPatterns/Disp_10to30_0to3000_NoPU/200723_204657/0000/',},
    #'Prompt_MidPt_PU200_SP'  : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/24Jul_bothPatterns/Disp_10to30_0to3000_PU200/200723_204524/0000/',},
    #'Prompt_HighPt_NoPU_SP'  : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/D',},
    #'Prompt_HighPt_PU200_SP' : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/24Jul_bothPatterns/Disp_30to100_0to3000_PU200/200723_205133/0000/',},

    #'Prompt_LowPt_NoPU_SP'   : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/24Jul_bothPatterns/Disp_2to10_0to3000_NoPU/200723_204216/0000/',},
    #'Prompt_LowPt_PU200_SP'  : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/24Jul_bothPatterns/Disp_2to10_0to3000_PU200/200723_205307/0000/',},
   #'Prompt_MidPt_NoPU_AP'   : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/Disp_10to30_0to3000_NoPU/200724_204759/0000/',},
   #'Prompt_MidPt_PU200_AP'  : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/Disp_10to30_0to3000_PU200/200724_204628/0000/',},
    #'Prompt_HighPt_NoPU_SP'  : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/24Jul_bothPatterns/',},
   #'Prompt_HighPt_PU200_AP' : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/Disp_30to100_0to3000_PU200/200724_205234/0000/',},
   ...
   #'Prompt_HighPt_PU200_DP_modeta' : { 'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/newEtaDisp/',},
   ...
   #'Prompt_HighPt_PU200_AP_modeta' : { 'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/newEtaDisp/',},
   ...
   'Prompt_pt30_AP' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'}, 
   'Prompt_pt30_BOTH' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'},
   'Prompt_pt30_DP' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'},
   'Prompt_pt30_AP_newEta' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'},
   'Prompt_pt30_BOTH_newEta' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'},
   'Prompt_pt30_DP_newEta' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'},
}
...
for dataset in datasets:
    ...
    for ev in events:
        ...
        for gen in gens:
            ...
            if abs(gen.eta()) < 1.24 and abs(gen.eta()) > 0.82: hPt0_q12_2GeV.Fill( passes_0_12, v_gen.Pt())
            ...
            if abs(gen.eta()) < 1.24 and abs(gen.eta()) > 0.82: hPt0_q12_1GeV.Fill( passes_0_12, v_gen.Pt())
