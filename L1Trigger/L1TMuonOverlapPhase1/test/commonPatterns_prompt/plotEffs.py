  ...
  for typ in types:
   for q in qualities:
      ...
      for charge in ["5GeV","3GeV","2GeV","1GeV"]:
            ...
            leg.Draw("same")
            canvas.SaveAs('~/www/omtf_2020/Oct07/tdr_pt_eff'+ dataset + "_" + charge+".pdf")
            canvas.SaveAs('~/www/omtf_2020/Oct07/tdr_pt_eff'+ dataset + "_" + charge+".png")
      ...
      leg.SetTextSize(0.035);
      leg.SetHeader('#splitline{p_{T}^{gen muon} #geq 0 GeV}{p_{T}^{L1 muon} #geq 0 GeV}')
      leg.Draw("same")
      canvas2.SaveAs('~/www/omtf_2020/Oct07/tdr_eta25_eff06'+ dataset+".pdf")
      canvas2.SaveAs('~/www/omtf_2020/Oct07/tdr_eta25_eff06'+ dataset+".png")
      ...
      leg.Draw("same")
      canvas9.SaveAs('~/www/omtf_2020/Oct07/tdr_dxy_'+ dataset+".pdf")
      canvas9.SaveAs('~/www/omtf_2020/Oct07/tdr_dxy_'+ dataset+".png")
