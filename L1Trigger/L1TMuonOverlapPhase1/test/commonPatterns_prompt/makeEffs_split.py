...
datasets = {
   ...
   'SplitPrompt_pt30_BOTH' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'},
   'SplitPrompt_pt30_BOTH_newEta' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_prompt/'},
}
        ...
        for gen in gens:
            ...
            for mu in goodmuons:
                ...
                if v_mu.DeltaR( v_gen ) < 0.5 and mu.hwQual() >= 12:
                    pt = v_mu.Pt() + (1000* v_mu.Pt() <= 1) # Just to make thinks clear when mixing displaced and non displaced
            ...
            passes_0_12 = pt >= 1000 and passes_0_12
            passes_3_12 = pt >= 1000 and passes_3_12
            passes_10_12 = pt >= 1000 and passes_10_12
            passes_20_12 = pt >= 1000 and passes_20_12
            if True:
             ...
             if abs(gen.eta()) < 1.24 and abs(gen.eta()) > 0.82: hPt0_q12_2GeVp1000.Fill( passes_3_12, v_gen.Pt())
             ...
             if abs(gen.eta()) < 1.24 and abs(gen.eta()) > 0.82: hPt0_q12_1GeVp1000.Fill( passes_3_12, v_gen.Pt())
