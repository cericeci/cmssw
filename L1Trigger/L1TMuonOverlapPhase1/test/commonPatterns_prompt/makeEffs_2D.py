...
datasets = {
   ...
   'Prompt_pt30_DOUBLE' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns/'}, 
   'Prompt_pt30_DOUBLE_newEta' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns/'},
}
...
dispHandle, dispLabel = Handle("BXVector<l1t::RegionalMuonCand>"), ("simBayesOmtfDigisPromptlaced", "OMTF", "L1TMuonEmulation" )
        ...
        for gen in gens:
            ...
            for i,mu in enumerate(goodmuons):
                ...
                if v_mu.DeltaR( v_gen ) < 0.5 and mu.hwQual() >= 12:
                   ...
                   if types[i] == "Promptlaced":
                     if v_mu.Pt() < 0.1 : foundPromptlaced = 0.05
                     elif v_mu.Pt() < 6000 : foundPromptlaced = 0.15
                     elif v_mu.Pt() < 11000 : foundPromptlaced = 0.25
                     else : foundPromptlaced = 0.35

            if foundPromptlaced and foundPrompt:
               hPt_dXY.Fill(foundPrompt, foundPromptlaced)
