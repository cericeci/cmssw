...
datasets = {
   ...
   'SplitDisp_pt30_BOTH' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns/'},
   'SplitDisp_pt30_BOTH_newEta' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns/'},
}
