...
datasets = {
   ...
   #'SplitDisp_pt30_BOTH_veto' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_displaced/'},
   'SplitDisp_pt30_BOTH_newEta_veto' : {'path' : '/nfs/fanae/user/carlosec/OMTF_2020/CMSSW_11_1_0_pre6/src/L1Trigger/L1TMuonOverlapPhase1/test/commonPatterns_displaced/'},
}
