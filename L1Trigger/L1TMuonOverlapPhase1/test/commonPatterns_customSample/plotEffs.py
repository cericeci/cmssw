  ...
  for typ in types:
   for q in qualities:
      ...
      for charge in ["5GeV","3GeV","2GeV","1GeV"]:
            ...
            leg.Draw("same")
            canvas.SaveAs('~/www/omtf_2020/Oct09/tdr_pt_eff'+ dataset + "_" + charge+".pdf")
            canvas.SaveAs('~/www/omtf_2020/Oct09/tdr_pt_eff'+ dataset + "_" + charge+".png")
      ...
      leg.Draw("same")
      canvas2.SaveAs('~/www/omtf_2020/Oct09/tdr_eta25_eff06'+ dataset+".pdf")
      canvas2.SaveAs('~/www/omtf_2020/Oct09/tdr_eta25_eff06'+ dataset+".png")
      ...
      leg.Draw("same")
      canvas9.SaveAs('~/www/omtf_2020/Oct09/tdr_dxy_'+ dataset+".pdf")
      canvas9.SaveAs('~/www/omtf_2020/Oct09/tdr_dxy_'+ dataset+".png")
