...
datasets = {
   ...
   'SingleMu_PU200_DP' : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/SingleMu_PU200/200724_205713/0000/',},
   ...
   'Disp_HighPt_PU200_DP' : { 'path' : '/pool/phedex/userstorage/carlosec/omtf/results/27Jul_bothPatterns/Disp_30to100_0to3000_PU200/200724_205234/0000/',},
...
for dataset in datasets:
    ...
    hDxy_q12_20steps  = ROOT.TEfficiency("hDxy_%s_q12_20steps"%dataset,"",20,0,300)
    ...
    outputDict[dataset]['hDxy_q12_20steps']     = hDxy_q12_20steps
    ...
    for ev in events:
        ...
        for gen in gens:
            ...
            passes_20_12 = False
            v_gen = getP4(gen)
            dxy_gen = (-1*gen.vx()* v_gen.Py() + gen.vy()* v_gen.Px()) / v_gen.Pt()
            ...
            hDxy_q12_20steps.Fill( passes_0_12, dxy_gen)
